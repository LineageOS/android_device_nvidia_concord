...
declare -a FLASH_CMD_FLASH=(
  ...
  --overlay_dtb AndroidConfig.dtbo,SetEkd2TestFmpPkcs7Cert.dtbo,tegra234-carveouts.dtbo,tegra234-p3737-audio-codec-rt5658-40pin.dtbo,tegra234-p3737-overlay.dtbo,tegra234-p3701-overlay.dtbo
  ...
  --scr_config tegra234-mb2-bct-scr-p3701-0000-lineage.dts

...
$(call intermediates-dir-for,EXECUTABLES,nv_bootloader_payload_updater)/nv_bootloader_payload_updater: $(TARGET_OUT_ETC)/firmware/TEGRA_BL.Cap $(TARGET_OUT_ETC)/firmware/kernel_only_payload
endif
